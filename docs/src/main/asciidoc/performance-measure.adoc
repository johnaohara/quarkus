...
Linux::
 ...
 The linux https://linux.die.net/man/1/ps[ps] tool provides a report on the native memory map for a process
...
--
 $ ps -o pid,rss,command -p <pid>
   ...
   PID   RSS COMMAND
 25002 12512 ./target/getting-started-1.0-SNAPSHOT-runner
--
